...
LocalPoint PixelCPEGeneric::localPosition(DetParam const& theDetParam, ClusterParam& theClusterParamBase) const {
  ...
  collect_edge_charges(theDetParam, theClusterParam, Q_f_X, Q_l_X, Q_f_Y, Q_l_Y);
...
//-----------------------------------------------------------------------------
void PixelCPEGeneric::collect_edge_charges(DetParam const& theDetParam, ClusterParam& theClusterParamBase,  //!< input, the cluster
